...
//获取第三方用户信息
func (a *AuthGithub) GetUserInfo(access_token string) (string, error) {
	return HttpGet("https://api.github.com/user?access_token=" + access_token)
}
